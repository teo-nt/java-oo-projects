...
public class AccountServiceImpl implements IAccountService {
    ...
    public Double withdraw(String iban, Double amount, String ssn)
        ...
        } catch (AccountNotFoundException | InsufficientBalanceException | NegativeAmountException |
    ...
    private Account mapFromAccountDTO(AccountDTO accountDTO) {
        return new Account(accountDTO.getId(), accountDTO.getIban(), mapFromUserDTO(accountDTO.getHolder()),
